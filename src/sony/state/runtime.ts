...
export function toSonyRawState(state: CameraState): SonyRawState {
  return {
    ...
    recDurationSec: state.recDurationSec,
    slotStatus: state.slotStatus,
    slotStatus2: state.slotStatus2,
    recRemainSec2: state.recRemainSec2,
    movieFileFormat: state.movieFileFormat,
    movieFileFormatList: state.movieFileFormatList,
    recSetting: state.recSetting,
    recSettingList: state.recSettingList,
    recMedia: state.recMedia,
    recFrameRate: state.recFrameRate,
    recFrameRateList: state.recFrameRateList,
    tally: state.tally,
    ...
    focalDistanceMin:     state.focalDistanceMin,
    focalDistanceMax:     state.focalDistanceMax,
    focalDistanceStep:    state.focalDistanceStep,
